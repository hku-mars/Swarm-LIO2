...
if(swarm_lio_CONFIG_INCLUDED)
  return()
endif()
set(swarm_lio_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(swarm_lio_SOURCE_PREFIX /home/fangcheng/workspace/uav_lio_ws/src/swarm_lio)
  set(swarm_lio_DEVEL_PREFIX /home/fangcheng/workspace/uav_lio_ws/src/swarm_lio/cmake-build-debug/devel)
  set(swarm_lio_INSTALL_PREFIX "")
  set(swarm_lio_PREFIX ${swarm_lio_DEVEL_PREFIX})
else()
  set(swarm_lio_SOURCE_PREFIX "")
  set(swarm_lio_DEVEL_PREFIX "")
  set(swarm_lio_INSTALL_PREFIX /usr/local)
  set(swarm_lio_PREFIX ${swarm_lio_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'swarm_lio' is deprecated")
...
if(NOT "/home/fangcheng/workspace/uav_lio_ws/src/swarm_lio/cmake-build-debug/devel/include;/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${swarm_lio_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'swarm_lio' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'swarm_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fangcheng/workspace/uav_lio_ws/src/swarm_lio/${idir}'.  ${_report}")
    endif()
    _list_append_unique(swarm_lio_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND swarm_lio_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND swarm_lio_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT swarm_lio_NUM_DUMMY_TARGETS)
      set(swarm_lio_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::swarm_lio::wrapped-linker-option${swarm_lio_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR swarm_lio_NUM_DUMMY_TARGETS "${swarm_lio_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::swarm_lio::wrapped-linker-option${swarm_lio_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND swarm_lio_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fangcheng/workspace/uav_lio_ws/src/swarm_lio/cmake-build-debug/devel/lib;/home/fangcheng/workspace/ws_livox/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(swarm_lio_LIBRARY_DIRS ${lib_path})
      list(APPEND swarm_lio_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'swarm_lio'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND swarm_lio_LIBRARIES ${lib})
    endif()
  endif()
...
set(swarm_lio_EXPORTED_TARGETS "swarm_lio_generate_messages_cpp;swarm_lio_generate_messages_eus;swarm_lio_generate_messages_lisp;swarm_lio_generate_messages_nodejs;swarm_lio_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${swarm_lio_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 swarm_lio_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${swarm_lio_dep}_FOUND)
      find_package(${swarm_lio_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${swarm_lio_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(swarm_lio_INCLUDE_DIRS ${${swarm_lio_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(swarm_lio_LIBRARIES ${swarm_lio_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${swarm_lio_dep}_LIBRARIES})
  _list_append_deduplicate(swarm_lio_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(swarm_lio_LIBRARIES ${swarm_lio_LIBRARIES})

  _list_append_unique(swarm_lio_LIBRARY_DIRS ${${swarm_lio_dep}_LIBRARY_DIRS})
  list(APPEND swarm_lio_EXPORTED_TARGETS ${${swarm_lio_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "swarm_lio-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${swarm_lio_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
