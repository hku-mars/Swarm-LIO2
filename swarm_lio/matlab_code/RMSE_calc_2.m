...
position_offset = [-3;0;1.5];
yaw_offset = 0; %degree

pose_esti = load('/home/fangcheng/workspace/uav_lio_ws/src/swarm_lio/swarm_lio/Log/quad2_mat_out.txt');
pose_real = load('/home/fangcheng/workspace/uav_lio_ws/src/swarm_lio/swarm_lio/Log/quad2_pose.txt');
